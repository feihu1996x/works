...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$100000$ymjT7UlwbCmy$C9SuGZvYlpln8ZkpeoVZZiYPcLoPv/GXauo19/xnyMc=','2018-11-17 01:26:01.877426',1,'feihu1996x','','','gsx0312@qq.com',1,1,'2018-08-25 20:26:42.190365');
...
INSERT INTO `main_works` VALUES (16,'images/cover/2018/08/hpshsystem_31RsYer.png','大数据统计与可视化系统','技术栈:  <br>\r\n- HTML/CSS/JavaScript/Echarts(数据可视化)  <br>\r\n- Flask(Web后端)/Python  <br>\r\n- MySQL/MongoDB(请求数据缓存, 体积较大的数据)/Redis(请求数据缓存)  <br>\r\n- Hadoop/Hive(海量数据处理与统计)/Sqoop(HDFS分布式文件系统与关系数据库之间数据互导)  <br>\r\n- Crontab(定时调度)/Nginx(反向代理)/Docker(应用容器)/Gunicorn(WSGI)/Supervisor(进程管理)  <br>','http://dev.feihu1996.cn/hpshSystem/','2018-08-25 20:57:00.000000',0),(17,'images/cover/2018/08/works.png','画廊式项目展示系统','技术栈:  <br>\r\n- HTML/CSS(3)/JavaScript/Vue.js  <br>\r\n- Django(Web 后端服务)/Xadmin(后台管理系统)  <br>\r\n- MySQL  <br>\r\n- Docker(容器端口映射) /Supervisor(进程管理)/Nginx(反向代理)/Gunicorn(WSGI)  <br>','http://dev.feihu1996.cn/works/','2018-08-26 21:04:00.000000',1),(18,'images/cover/2018/08/randomKey.png','随机密码生成器','技术栈:  <br>\r\n- HTML/CSS/JavaScript(原生Ajax)  <br>\r\n- Python/Flask(Web后端服务)  <br>\r\n- Docker(容器端口映射)/Supervisor(进程管理)/Nginx(反向代理)  <br>','http://dev.feihu1996.cn/randomKey/','2018-08-27 00:32:00.000000',2),(19,'images/cover/2018/08/mmovie.png','仿豆瓣电影APP','技术栈:  <br>\r\n- HTML/CSS/JavaScipt/MUI(高性能移动前端框架) /Vue.js  <br>\r\n- Node.js/Express(网站后台框架)  <br>\r\n- pm2(进程管理器) /Docker(端口映射) /Nginx(反向代理)  <br>','http://dev.feihu1996.cn/MMovie/','2018-08-27 05:12:00.000000',3),(20,'images/cover/2018/08/WMovie.png','仿豆瓣电影微信小程序','技术栈:  <br>\r\n- WXML/WXSS/JavaScript  <br>\r\n- BootStrap(网站前台)  <br>\r\n- Node.js/Express(网站后台框架)  <br>\r\n- Docker(容器端口映射)/Nginx(反向代理) /PM2(进程管理器)  <br>','http://dev.feihu1996.cn/WMovie/','2018-08-27 07:27:00.000000',4),(21,'images/cover/2018/09/qinxueonline.png','仿\"中国大学MOOC\"网站','技术栈： <br>\r\n- HTML/CSS/JavaScript/JQuery  <br>\r\n- Django(Web后端服务) /Xadmin(后台管理系统)  <br>\r\n- MySQL  <br>\r\n- Docker(容器端口映射) /Supervisor(进程管理) /Nginx(反向代理)/Gunicorn(WSGI)  <br>\r\n- urllib/Selenium/多线程/Redis  <br>','http://dev.feihu1996.cn/qinXueOnLine/','2018-09-01 02:30:00.000000',7),(22,'images/cover/2018/09/nexttodo.png','Web Todo应用','技术栈:  <br>\r\n- HTML/CSS/JavaScript/Vue.js/Webpack  <br>\r\n- Node.js/Express  <br>\r\n- Docker(容器端口映射)/Nginx(反向代理)/PM2(Node服务进程管理)  <br>','http://dev.feihu1996.cn/nextToDo/','2018-09-02 02:23:00.000000',6),(23,'images/cover/2018/09/fakelottery_1YZvmam.png','使用ES6构建的彩票项目','技术栈：<br>\r\n- HTML/CSS/JavaScript(ECMAScript6)  <br>\r\n- Gulp(自动化构建工具)  <br>\r\n- Node.js/Express  <br>\r\n- Docker(容器端口映射) /Nginx(反向代理)/PM2(Node服务进程管理)  <br>','http://dev.feihu1996.cn/fakeLottery/','2018-09-02 07:30:00.000000',5),(24,'images/cover/2018/09/qq_group_needs.png','QQ/微信群信息抓取系统','技术栈：<br >\r\n- HTML/CSS/JavaScript/Vue.js/Node.js/Express/pm2 <br>\r\n- Python/Flask/SQLAlchemy/Gunicorn/Gevent <br>\r\n- MySQL <br>\r\n- Nginx <br>\r\n- PyAutoGUI/Pywinauto <br>\r\n- Selenium/Appium <br>','http://dev.feihu1996.cn/qqGroupNeeds/','2018-09-24 20:44:00.000000',8),(25,'images/cover/2018/11/vueMall.png','简易商城系统','技术栈: <br>\r\n- HTML5/CSS3 <br>\r\n- ES6 <br>\r\n- Vue全家桶 <br>\r\n- Webpack <br>\r\n- Node.js/Express <br>\r\n- MongoDB <br>\r\n- PM2 <br>\r\n- Nginx <br>','http://dev.feihu1996.cn/vueMall','2018-11-02 18:22:00.000000',9),(26,'images/cover/2018/11/koaMovie.png','电影网站（集成微信公众号）','技术栈 <br>\r\n- Node.js/Koa2 <br>\r\n- MongoDB/mongoose <br>\r\n- 微信 JS-SDK <br>\r\n- Pug <br>\r\n- Bootstrap <br>\r\n- HTML/CSS <br>\r\n- JavaScript <br>\r\n- JavaScript Standard Style <br>\r\n- PM2 <br>','http://dev.feihu1996.cn/koaMovie/','2018-11-17 01:32:00.000000',10);
...
-- Dump completed on 2018-11-17  1:43:16
